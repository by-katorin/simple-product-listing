...
export default function Index() {
  ...
  return (
    <section className="bg-gray-50 mb-8 mt-4 py-3 px-4 antialiased md:my-8 rounded-md">
      <div className="-ms-5">
      ...
      <div className="mx-auto max-w-screen-xl 2xl:px-0">
        <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
          <div>
            <h4 className="px-2 mt-3 text-center text-2xl font-bold">All Products</h4>
          </div>
          <SearchBar
                    ...
                    >
                      ...
                      <div className="pt-6">
                        ...
                        <div className="mt-2 flex items-center gap-2">
                          ...
                          <p className="text-sm font-medium text-gray-500">({Math.floor(Math.random() * 500)})</p>
                        </div>
                        ...
                        <ul className="mt-2 flex items-center gap-4">
                          <li className="flex items-center gap-2">
                            ...
                            <p className="text-xs font-medium text-gray-500">{product.shippingInformation}</p>
                          </li>
                          ...
                          <li className="flex items-center gap-2">
                            ...
                            <p className="text-xs font-medium text-gray-500">{product.warrantyInformation}</p>
                          </li>
                        </ul>
