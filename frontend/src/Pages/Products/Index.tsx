...
export default function Index() {
  ...
  const filteredResults = currentProducts.filter((product: any) => {
  ...
  return (
    <section className="bg-gray-50 mb-8 mt-4 py-3 px-4 antialiased dark:bg-gray-900 md:my-8 rounded-md">
      ...
      <div className="mx-auto max-w-screen-xl 2xl:px-0">
        <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
          <div>
            <h4 className="px-2 mt-3 text-center text-2xl font-bold dark:text-white">All Products</h4>
          </div>
          <SearchBar
        ...
        {loading ? (
          ...
          filteredResults.length === 0 ? (
            <p className='flex items-center justify-center text-center w-full mx-auto py-16'>
                    ...
                    >
                      ...
                      <div className="pt-6">
                        ...
                        <div className="mt-2 flex items-center gap-2">
                          ...
                          <p className="text-sm font-medium text-gray-500 dark:text-gray-400">({Math.floor(Math.random() * 500)})</p>
                        </div>
                        ...
                        <ul className="mt-2 flex items-center gap-4">
                          <li className="flex items-center gap-2">
                            ...
                            <p className="text-xs font-medium text-gray-500 dark:text-gray-400">{product.shippingInformation}</p>
                          </li>
                          ...
                          <li className="flex items-center gap-2">
                            ...
                            <p className="text-xs font-medium text-gray-500 dark:text-gray-400">{product.warrantyInformation}</p>
                          </li>
                        </ul>
          ...
          <p className='flex items-center justify-center text-center w-full mx-auto py-16'>No products available.</p>
        )}
      </div>
    </section>
  );
