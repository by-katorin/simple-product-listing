      ...
      <nav className="flex px-2" aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          <li className="inline-flex items-center">
            <a href="/" className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-primary-600">
          ...
          <li>
            <div className="flex items-center">
              ...
              <a href="#" className="ms-1 text-sm font-medium text-gray-700 hover:text-primary-600 md:ms-2">
                {currentPage}
              </a>
            </div>
          </li>
